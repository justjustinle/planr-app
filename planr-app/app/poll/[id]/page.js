...
function LinkButtons({ venue }) {
  ...
  return (
    <div style={{ display: 'flex', gap: '6px', marginTop: '10px' }}>
      {venue.menu_url && <a href={venue.menu_url} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()} style={btnStyle}>{['drink', 'play'].includes(venue.activity_type?.toLowerCase()) ? 'WEBSITE' : 'MENU'}</a>}
